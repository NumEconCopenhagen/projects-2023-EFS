...
class HouseholdSpecializationModelClass():
    ...
    def calc_utility(self,LM,HM,LF,HF):
        ...
        # b. home production conditional on sigma values
        if par.sigma == 1:
        ...
        utility = np.fmax(Q,1e-8)**(1-par.rho)*(1/(1-par.rho))
    ...
    def solve_discrete(self,do_print=False,relH=True):
        ...
        if do_print:
            for k,v in opt.__dict__.items():
                print(f'{k} = {v:6.4f}')
            return opt
            #print(f'HF/HM = {opt.HF/opt.HM:6.4f}') #added relative value print
    ...
    def HF_on_HM_table(self,alpha_vec,sigma_vec):
